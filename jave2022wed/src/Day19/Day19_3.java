...
public class Day19_3 {
	...
	//HachMap : 컬렉션프레임워크 map 클래스
		...
		// 3. map객체명.size() : 엔트리(키)수 호출
		System.out.println("map 객체내 엔트리 수 : " + map.size());
		// 4. map객체명.get(키값) : 값 호출 
		System.out.println("map 객체내 값 호출 (키호출시->값호출) : " + map.get("유재석"));
