...
public class Book { // c s
	...
	void 도서검색() { // 검색 s
		System.out.println(" 검색 단어 입력 : "); String bName = Day07_05Application.scanner.next();
		for(Book temp : Day07_05Application.book) { // for s
	...
	void 도서대여(String loginid) { // 대여 s
		System.out.println("도서 ISBN : "); String iSbn = Day07_05Application.scanner.next();
		for(Book temp : Day07_05Application.book) { // for s
	...
	void 도서등록() { // 등록 s
		System.out.println("등록할 도서명 입력 : "); String bName = Day07_05Application.scanner.next();
		System.out.println("도서의 ISBN 입력 : "); String iSbn = Day07_05Application.scanner.next();
		//ISBN 중복체크
		for(Book temp : Day07_05Application.book) {
		...
		System.out.println("도서의 작가명 입력 : "); String bWriter = Day07_05Application.scanner.next();
