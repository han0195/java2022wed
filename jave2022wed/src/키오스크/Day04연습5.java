	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(ch == 1) {
				...
				if(ch2 == 1) {
					System.out.println("돈을 입금해주세요 "); int 돈 = s.nextInt();
					while(true) {
						if(돈 > 총) {
							...
							System.out.println("돈이 부족합니다 다시: "); 돈 = s.nextInt();
						}
					}
				}else if(ch2 == 2) {
					System.out.println("결제가 취소되었습니다 장바구니를 초기화합니다");
					콜재 += 콜; 환재 += 환; 사재 = 사;
					콜 = 0; 환 = 0; 사 =0;
				}else {
