...
public class productupdate implements Initializable{
	    ...
	    void img(ActionEvent event) {
	    	...
	    	// 3. 바이트 배열 선언 
	    		byte[] bytes = new byte[1024*1024*50]; // 1바이트 -> 1024바이트 -> 1키로바이트 -> 1024키로바이트-> 1메가바이트
