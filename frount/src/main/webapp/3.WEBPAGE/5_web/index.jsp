...
<body>
	...
	<div class="row">
		<div class="col-md-2 sidemenu sidbar"> <!-- 사이드바 메뉴 -->
			<h3> HUNS </h3>
			<ul>
				<li> BEST </li>
				<li> NEW </li>
			...
			<div>
				<input type="text" style="margin-bottom: 30px; border-top: none; border-left: none; border-right: none; width: 100px;"> <i class="fas fa-search"></i>
			</div>
			<div class="se">
				<span style="font-weight: bold;">고객센터　xxx-xxxx-xxxx <br>
				카카오채널 @이젠 <br></span>
				MON - FRI AM9 - PM4 <br>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/캐러셀1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/캐러셀2.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/캐러셀3.jpg" class="d-block w-100" alt="...">
    </div>
  </div>
